...
<html>
	...
	<style type="text/css">
		...
		#header .navs li.current {
			...
			border-width: 1.5px;
			border-style: dashed;
			border-color: rgba(245, 246, 240, 1);
			background-color: rgba(255, 255, 255, 1);
			box-shadow: 0px 0px 0px 3px #D1CAB8;
		}
	...
	<body>
		...
		<div id="header">
			<div v-if='true' class="nav-top">
			  <img v-if='false' class="nav-top-img" src='http://codegen.caihongy.cn/20220105/0c37dc602f384a618b50d1e176ca9da4.png'>
			  <div v-if="true" class="nav-top-title">{{projectName}}</div>
			  <div class="nav-top-tel"></div>
			</div>
						
			<div v-if="true" class="navs navs1" :style='{"width":"150px","boxShadow":"0 1px 6px rgba(0,0,0,0)","background":"#f7f7f7"}'>
		...
		<div id="tabbar" v-if="true" class="tabbar" :style='{"padding":"30px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}' style="position: relative;">
		  ...
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="company"></div>
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"32px","fontSize":"9px","borderStyle":"solid"}' class="record">沪ICP备13031638号</div>
		  <div style='box-sizing: border-box;' :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(255,255,255,1)","backgroundColor":"#000","color":"#fff","textAlign":"center","borderRadius":"0","borderWidth":"0","width":"40%","lineHeight":"32px","fontSize":"14px","borderStyle":"solid"}' class="desc"></div>
		</div>
