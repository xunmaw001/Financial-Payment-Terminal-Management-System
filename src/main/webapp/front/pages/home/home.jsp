...
<html>
	...
	<body>
		...
		<div id="app">
				  ...
				  <div class="box" style='width:80%'>
					...
					<div class="list-4">
					    <div v-if="shangpinxinxiRecommend.length>0" class="list-4-item animation-box item-1" @click="jump('../shangpinxinxi/detail.jsp?id='+shangpinxinxiRecommend[0].id)" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 0 0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"177px 177px 0px 177px","borderWidth":"0","width":"360px","borderStyle":"solid","height":"500px"}'>
									<img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(209, 202, 184, 1)","backgroundColor":"#ccc","borderRadius":"177px 177px 0px 177px","borderWidth":"10px","width":"100%","borderStyle":"solid","height":"100%"}' :src="shangpinxinxiRecommend[0].shangpintupian?baseurl+shangpinxinxiRecommend[0].shangpintupian.split(',')[0]:''" alt="" />
					    ...
					    <div class="list-4-body">
					    			<div v-if="shangpinxinxiRecommend.length>1" @click="jump('../shangpinxinxi/detail.jsp?id='+shangpinxinxiRecommend[1].id)" class="list-4-item animation-box item-2" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 20px 20px 0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","width":"250px","borderStyle":"solid","height":"230px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(209, 202, 184, 1)","backgroundColor":"#ccc","borderRadius":"177px 177px 0px 177px","borderWidth":"10px","width":"100%","borderStyle":"solid","height":"100%"}' :src="shangpinxinxiRecommend[1].shangpintupian?baseurl+shangpinxinxiRecommend[1].shangpintupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"30px 0 ","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 0 0 60%","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"100px 100px 0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			...
					    			<div v-if="shangpinxinxiRecommend.length>2" @click="jump('../shangpinxinxi/detail.jsp?id='+shangpinxinxiRecommend[2].id)" class="list-4-item animation-box item-3" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"20px 20px 0 0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","width":"250px","borderStyle":"solid","height":"230px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(209, 202, 184, 1)","backgroundColor":"#ccc","borderRadius":"177px 177px 0px 177px","borderWidth":"10px","width":"100%","borderStyle":"solid","height":"100%"}' :src="shangpinxinxiRecommend[2].shangpintupian?baseurl+shangpinxinxiRecommend[2].shangpintupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"30px 0 ","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 0 0 60%","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"100px 100px 0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    ...
					    <div class="list-4-body">
					    			<div v-if="shangpinxinxiRecommend.length>3" @click="jump('../shangpinxinxi/detail.jsp?id='+shangpinxinxiRecommend[3].id)" class="list-4-item animation-box item-4" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"0 0 20px 0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","width":"250px","borderStyle":"solid","height":"230px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(209, 202, 184, 1)","backgroundColor":"#ccc","borderRadius":"177px 177px 0px 177px","borderWidth":"10px","width":"100%","borderStyle":"solid","height":"100%"}' :src="shangpinxinxiRecommend[3].shangpintupian?baseurl+shangpinxinxiRecommend[3].shangpintupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"30px 0 ","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 0 0 60%","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"100px 100px 0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
					    			...
					    			<div v-if="shangpinxinxiRecommend.length>4" @click="jump('../shangpinxinxi/detail.jsp?id='+shangpinxinxiRecommend[4].id)" class="list-4-item animation-box item-5" :style='{"padding":"0","boxShadow":"0 0 0px rgba(0,0,0, .3)","margin":"20px 0  0","borderColor":"#ccc","backgroundColor":"rgba(255, 255, 255, 1)","borderRadius":"0","borderWidth":"0","width":"250px","borderStyle":"solid","height":"230px"}'>
					    			  <img :style='{"padding":"0","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0","borderColor":"rgba(209, 202, 184, 1)","backgroundColor":"#ccc","borderRadius":"177px 177px 0px 177px","borderWidth":"10px","width":"100%","borderStyle":"solid","height":"100%"}' :src="shangpinxinxiRecommend[4].shangpintupian?baseurl+shangpinxinxiRecommend[4].shangpintupian.split(',')[0]:''" alt="" />
					    			  <div :style='{"padding":"30px 0 ","boxShadow":"0 0 6px rgba(0,0,0,0)","margin":"0 0 0 60%","borderColor":"#ccc","backgroundColor":"rgba(0,0,0,.3)","borderRadius":"100px 100px 0","borderWidth":"0","width":"40%","borderStyle":"solid","height":"auto"}' v-if="true" class="list-4-item-center">
			...
			<!-- 图文列表 -->
				<!-- 样式二 -->
				<div class="news index-pv3" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(110,22,64,.8)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"#fff url(\"http://codegen.caihongy.cn/20220106/6ce5262c556a44779870b247d32fb35a.png\") no-repeat top","borderStyle":"solid"}'>
				  <div class="box" style='width:60%'>
				    ...
				    <div class="title" :style='{"isshow":true,"padding":"30px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"40px 40% 20px","borderColor":"rgba(245, 246, 240, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"51px 51px 0px 51px","alignItems":"center","borderWidth":"10px","fontSize":"16px","borderStyle":"solid"}'>
				    ...
				    <div class="list">
				      <div v-for="(item,index) in shangpinxinxiList" :key="index" @click="jump('../shangpinxinxi/detail.jsp?id='+item.id)" :class="2=='1'?'list-item1':2=='3'?'list-item3':''">
				        <div class="list-item-body animation-box" :style='{"padding":"6px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"40px 60px","borderColor":"rgba(0,0,0,.3)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
						  <img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(209, 202, 184, 1)","borderRadius":"50%","borderWidth":"2px 10px","width":"138px","borderStyle":"solid","height":"138px"}' :src="item.shangpintupian?baseurl+item.shangpintupian.split(',')[0]:''" alt="" />
				          <div class="item-info">
							<div  class="line1" v-if='true' :style='{"isshow":true,"padding":"40px 20px 40px 300px","margin":"-120px 0 0","backgroundColor":"rgba(245, 246, 240, 1)","color":"rgba(110,22,64,1)","borderRadius":"62px","textAlign":"right","fontSize":"14px"}' class="name">{{item.shangpinmingcheng}}</div>
				          </div>
				        </div>
				      </div>
				    </div>
