			...
			<div class="center-container">
				...
				<div class="right-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(110,22,64,.0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<form style="margin-top: 20px;" class="layui-form" lay-filter="myForm">
						<div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 0 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"rgba(245, 245, 245, 1)","borderRadius":"0","borderWidth":"0 0 0px 0","borderStyle":"solid"}' class="layui-form-item layui-form-text">
						...
						<div :style='{"padding":"10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 0 0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"rgba(245, 245, 245, 1)","borderRadius":"0","borderWidth":"0 0 0px 0","borderStyle":"solid"}' class="layui-form-item layui-form-text l-redio">
