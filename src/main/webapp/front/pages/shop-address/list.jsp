	...
	<body style="background: #EEEEEE;">
		...
		<div id="app">
			...
			<div class="center-container">
				...
				<!-- 个人中心菜单 -->
				<div class="right-container" style="padding-top: 0;" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(110,22,64,.0)","margin":"0","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
					<div class="btn-container" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						<button :style='{"padding":"0 15px","boxShadow":"0 0 0px rgba(0,0,0,0)","margin":"0 0 0 10px","borderColor":"#409EFF","backgroundColor":"rgba(209, 202, 184, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"40px"}' id="btn-add" class="layui-btn layui-btn-lg btn-theme">
							<i v-if="false" class="layui-icon">&#xe654;</i> 添加新地址
						</button>
					</div>
